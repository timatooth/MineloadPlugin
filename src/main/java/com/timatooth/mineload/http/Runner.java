...
class Runner implements Runnable {
     ...
     * cookie information and produces a Request object. Registered handlers
     * deal with the requests when they're generated to produce Response objects
     * which are sent back.
     */
    @Override
    public void run() {
    ...
    /**
     * Parse the initial request line. E.g GET / HTTP/1.1 or: POST /data
     * HTTP/1.1
     *
     * @param line
